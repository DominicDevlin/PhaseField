...
for gamma12 in gamma12_values:
    for dr in drates:
            ...
            output.append((sig12, sig13, sig23, dr))
            print(sig12, sig13, sig23)
            

sigma12, sigma13, sigma23, drate = output[index]
...
command = ["FreeFem++", "three-field.edp", sigma12_str, sigma13_str, sigma23_str, eps_str, drate_str]
